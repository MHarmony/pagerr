...
Please make sure to read the [Issue Reporting Checklist](https://github.com/MHarmony/pagerr/blob/main/CONTRIBUTING.md#-submitting-an-issue) before opening an issue. Issues not conforming to the guidelines may be closed immediately.
...
pagerr is [MIT licensed](LICENSE.md).
